...
const myTimerPromise = new Promise<string>((resolve, reject) => {
...
const whatDataisInThisPromise: Promise<number> =  myTimerPromise.then(function onfullfilled(msg: string) {
...
myTimerPromise.then(function onfullfilled(msg: string) {
